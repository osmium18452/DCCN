...
\begin{document}
	...
	\begin{figure}[!ht]
		\centering
		\includegraphics[width=0.25\textwidth]{pic/pavia_gt.eps}
		\includegraphics[width=0.25\textwidth]{pic/paviaU_gt.eps}
		\includegraphics[width=0.25\textwidth]{pic/salinas_gt.eps}
		\includegraphics[width=0.25\textwidth]{pic/salinasA_gt.eps}
